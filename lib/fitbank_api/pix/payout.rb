...
module FitBankApi
  module Pix
    ...
    class Payout
      ...
      # @param [String] Idempotency key generated by us. At most one request made with this key
      # will be performed
      ...
      def call
        ...
        # All responses from this API will have status 200. We need to check "Success" field
        # Currently if some field of the payload cannot be parsed or is missing or there
        # is some general error we get this
        # {
        #   "Success": "false",
        #   "Message": "Houve um erro no sistema. Tente novamente mais tarde"
        # }
        # This looks like a 500 but it's actually kind of "general error".

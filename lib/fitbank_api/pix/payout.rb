...
module FitBankApi
  module Pix
    ...
    class Payout
      ...
      # @param [String] sender_tax_number CPF/CNPJ of the person/company sending the
      #   money. If left blank it will be the CNPF from the credentials.
      def payload(
        receiver_bank_info:,
        pix_key: nil,
        pix_key_type: nil,
        ...
        # TODO: Currently if Bank or ToBank are different than "450" the API responds with error
        {
          ...
          TaxNumber: sender_tax_number || @credentials.cnpj,
          # Receiver Bank Data
